...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          ...
          console.log('Registration successful, hello' +  username);
          //save user Id in useContext
          setUserId(_id);
  ...
  return (
    <div className='mt-[3rem] md:flex block'>
        ...
        <p className='text-center font-bold text-[1.5rem] '>Create an account</p>
        ...
        <p className='text-center mb-3'>already have an account ? <span className='hover:cursor-pointer text-green-400' onClick={() => {router.push('/login')}}>Login</span></p>
        </div>
    </div>
  )
}
